...
En este ejercicio debemos elegir 2 métricas diferentes y testear un lote de tareas \textbf{TaskBatch}, todas ellas con igual uso de CPU pero con diversas
...
el mismo termina. Es decir, es la suma de los períodos usados en esperar datos de memoria, en estar encolado en la ``ready queue'', ejecutandose en 
...
\newline
\newline
Elegimos estas métricas ya que, con el Turnaround, tenemos una visión global de cómo se comportan los procesos, mientras que con el Waiting Time
podemos observar cómo un hecho más puntual, el tiempo que los procesos pasan encolados, impacta en el tiempo de ejecución total del proceso.
\newline
\newline
...
\begin{itemize}
 ...
 indicaría que es buena idea aumentar el quantum, pero sin embargo a medida que se aumenta este, aumenta también el desvío estándar, lo cual implica que los valores
 de Turnaround y Waiting Time se encuentran más dispersos. Esto significa que va a haber procesos que terminen relativamente rápido mientras que otros no, lo cual disminuye
 ...
 reduciendo a su vez el desvío estándar. Por lo tanto, obviamente, un aumento en la cantidad de cores siempre es beneficioso.
 ...
 \item Lógicamente, los procesos que más llamadas bloqueantes realizan son los que más tiempo tardan en terminar. Sin embargo, en la mayor parte de los casos, 
 la diferencia en los valores de Turnaround no es demasiado significativa.
 \item El valor óptimo del quantum para ambas métricas sería $4$, si se tolera el desvío estándar asociado.
\end{itemize}
